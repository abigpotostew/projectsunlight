...
function EaseX.easeIn(t, tMax, start, delta)
        return start + (delta * _easeIn(t/tMax))
end

function EaseX.easeOut(t, tMax, start, delta)
        return start + (delta * _easeOut(t/tMax))
end

function EaseX.easeInOut(t, tMax, start, delta)
        return start + (delta * _easeInOut(t/tMax))
end

function EaseX.easeOutIn(t, tMax, start, delta)
        return start + (delta * _easeOutIn(t/tMax))
end

function EaseX.easeInBack(t, tMax, start, delta)
        return start + (delta * _easeInBack(t/tMax))
end

function EaseX.easeOutBack(t, tMax, start, delta)
        return start + (delta * _easeOutBack(t/tMax))
end

function EaseX.easeInOutBack(t, tMax, start, delta)
        return start + (delta * _easeInOutBack(t/tMax))
end

function EaseX.easeOutInBack(t, tMax, start, delta)
        return start + (delta * _easeOutInBack(t/tMax))
end

function EaseX.easeInElastic(t, tMax, start, delta)
        return start + (delta * _easeInElastic(t/tMax))
end

function EaseX.easeOutElastic(t, tMax, start, delta)
        return start + (delta * _easeOutElastic(t/tMax))
end

function EaseX.easeInOutElastic(t, tMax, start, delta)
        return start + (delta * _easeInOutElastic(t/tMax))
end

function EaseX.easeOutInElastic(t, tMax, start, delta)
        return start + (delta * _easeOutInElastic(t/tMax))
end

function EaseX.easeInBounce(t, tMax, start, delta)
        return start + (delta * _easeInBounce(t/tMax))
end

function EaseX.easeOutBounce(t, tMax, start, delta)
        return start + (delta * _easeOutBounce(t/tMax))
end

function EaseX.easeInOutBounce(t, tMax, start, delta)
        return start + (delta * _easeInOutBounce(t/tMax))
end

function EaseX.easeOutInBounce(t, tMax, start, delta)
